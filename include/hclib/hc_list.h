...
HC_API struct hc_list_node *hc_list_node_allocate(struct hc_allocator const *allocator);
HC_API void                 hc_list_node_free(struct hc_list_node *node, struct hc_allocator const *allocator);

HC_API void                 hc_list_node_init(struct hc_list_node *node, void *data);
...
HC_API void                 hc_list_destroy(struct hc_list *list,
                                            struct hc_destructor const *data_destructor,
                                            struct hc_allocator const *node_allocator);
